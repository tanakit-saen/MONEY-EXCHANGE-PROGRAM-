 ...
 * @author jay
 */
public class CFH extends javax.swing.JFrame {

    /**
     * Creates new form CFH
     */
    public CFH() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("CHF-Swiss France");

        jLabel3.setText("CHF-Swiss France");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CFH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
